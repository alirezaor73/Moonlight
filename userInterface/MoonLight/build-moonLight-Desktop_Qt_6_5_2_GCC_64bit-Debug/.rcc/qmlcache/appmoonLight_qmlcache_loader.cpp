...
namespace _moonLight_CalibrationPage_qml { 
    extern const unsigned char qmlData[];
    extern const QQmlPrivate::TypedFunction aotBuiltFunctions[];
    const QQmlPrivate::CachedQmlUnit unit = {
        reinterpret_cast<const QV4::CompiledData::Unit*>(&qmlData), &aotBuiltFunctions[0], nullptr
...
Registry::Registry() {
    ...
    resourcePathToCachedUnit.insert(QStringLiteral("/moonLight/CalibrationPage.qml"), &QmlCacheGeneratedCode::_moonLight_CalibrationPage_qml::unit);
...
int QT_MANGLE_NAMESPACE(qInitResources_qmlcache_appmoonLight)() {
    ::unitRegistry();
    return 1;
}
Q_CONSTRUCTOR_FUNCTION(QT_MANGLE_NAMESPACE(qInitResources_qmlcache_appmoonLight))
int QT_MANGLE_NAMESPACE(qCleanupResources_qmlcache_appmoonLight)() {
    return 1;
}
