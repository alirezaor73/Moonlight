...
0xfc,0x1d,0x0,0x0,0x61,0x34,0x64,0x37,
...
0x0,0x0,0x0,0x0,0xbc,0x77,0x33,0x6a,
0x69,0xae,0x5c,0xe0,0x6f,0x28,0x2f,0xbc,
0x57,0xac,0xe,0x1,0x0,0x0,0x0,0x0,
0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,
...
r2_1 = [&](){ auto arg = QStringLiteral("#4DB6AC"); return aotContext->constructValueType([]() { static const auto t = QMetaType::fromName("QColor"); return t; }(), []() { static const auto t = QMetaType::fromName("QQuickColorValueType"); return t; }().metaObject(), 0, &arg); }();
// generate_SetLookup
{
...
// generate_SetLookup
{
while (!aotContext->setObjectLookup(32, r7_0, r2_1.data())) {
aotContext->setInstructionPointer(12);
aotContext->initSetObjectLookup(32, r7_0, r2_1.metaType());
if (aotContext->engine->hasError())
    return ;
}
}
...
// generate_SetLookup
{
while (!aotContext->setObjectLookup(34, r7_0, r2_1.data())) {
aotContext->setInstructionPointer(12);
aotContext->initSetObjectLookup(34, r7_0, r2_1.metaType());
if (aotContext->engine->hasError())
    return ;
}
}
